          ...
          <div className="row align-items-center" data-aos="fade-up">
            <div className="col-lg-9">
              <div className="main-title2">
                <h2 className="title">Descubra os nossos destaques</h2>
          ...
          <div className="row  justify-content-between align-items-center">
            <div className="col-auto">
              <div
                ...
                data-aos-delay="100"
              >
                <h2 className="title">Explore as Cidades</h2>
                <p className="paragraph">
                  Aliquam lacinia diam quis lacus euismod
                </p>
              </div>
            ...
            <div className="row">
              ...
              >
                <div className="main-title text-center">
                  <h2 className="title">Veja como Minha Casa pode te ajudar</h2>
                  <p className="paragraph">
                    Aliquam lacinia diam quis lacus euismod
                  </p>
                </div>
            ...
            <div className="row">
              ...
              >
                <div className="main-title text-center">
                  <h2>Depoimentos</h2>
                  <p className="paragraph">
                    10,000+ cursos online de design
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row  justify-content-between align-items-center">
            <div className="col-auto">
              <div
                ...
                data-aos-delay="100"
              >
                <h2 className="title">Nossos agentes exclusivos</h2>
                <p className="paragraph">
                  Aliquam lacinia diam quis lacus euismod
                </p>
              </div>

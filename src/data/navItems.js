...
export const propertyItems = [
  ...
  },
  {
    ...
    subMenuItems: [
      ...
      { label: "Mensagem", href: "/dashboard-message" },
      { label: "Nova Propriedade", href: "/dashboard-add-property" },
      { label: "Minhas Propriedades", href: "/dashboard-my-properties" },
      { label: "Meus favoritos", href: "/dashboard-my-favourites" },
      { label: "Pesquisas salvas", href: "/dashboard-saved-search" },
      { label: "Avaliaçōes", href: "/dashboard-reviews" },
      { label: "Meus planos", href: "/dashboard-my-package" },
      { label: "Meu Perfil", href: "/dashboard-my-profile" },
    ],
  },
];

  ...
  const iconboxData = [
    {
      ...
      title: "Compra uma propriedade",
      text: "Nullam sollicitudin blandit eros eu pretium. Nullam maximus ultricies auctor.",
      linkText: "Compra uma casa",
    },
    {
      icon: "/images/icon/property-sell-2.svg",
      title: "Vender uma propriedade",
      text: "Nullam sollicitudin blandit eros eu pretium. Nullam maximus ultricies auctor.",
      linkText: "Vender uma propriedade",
    },
    {
      icon: "/images/icon/property-rent-2.svg",
      title: "Arrendar uma propriedade",
      text: "Nullam sollicitudin blandit eros eu pretium. Nullam maximus ultricies auctor.",
      linkText: "Arrenda uma casa",
    },
  ];

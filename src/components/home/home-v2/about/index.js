    ...
    <div className="row mt80 mt0-md">
      ...
      <div className="col-md-6 col-xl-4 offset-xl-2">
        <div className="about-box-1">
          <h2 className="title mb30">Deixe-nos ajudá-lo a encontrar a casa dos seus sonhos.</h2>
          <p className="text mb20 fz15">
          À medida que a complexidade das construções aumenta, também cresce o campo da 
          arquitetura.
          </p>
          <Funfact />
        </div>

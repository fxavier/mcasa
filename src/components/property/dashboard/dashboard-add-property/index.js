      ...
      <div className="tab-content" id="nav-tabContent">
        ...
        >
          <div className="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
            <h4 className="title fz17 mb30">Descrição da propriedade</h4>
            <PropertyDescription />
          </div>
        </div>
        ...
        >
          <div className="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
            <h4 className="title fz17 mb30">Localização</h4>
            <LocationField />
          </div>
        </div>
        ...
        >
          <div className="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
            <h4 className="title fz17 mb30">Detalhes</h4>
            <DetailsFiled />
          </div>
        </div>
        ...
        >
          <div className="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
            <h4 className="title fz17 mb30">Selecione Comodidades</h4>
            <div className="row">
              <Amenities />
            </div>
          </div>
